...
export function FormPicker({id , errors}: FormPickerProps) {
    ...
    const [selectedImageId , setSlectedImageId] = useState<null | string>(null);

    useEffect(() => {
        const fetchImages = async() => {
            try{
                const result = await unsplash.photos.getRandom({
                    collectionIds: ["UeFfyoT5frQ"],
                    count: 9,
                })
...
// https://unsplash.com/collections/UeFfyoT5frQ/renders